              ...
              <!-- SLIDE 1 -->
               <?php 
                  $i=1;
                      ...
                      extract($data);
                ?>
              <li data-index="rs-'<?php echo $i++; ?>'" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="images/gallery/<?php echo $photo; ?>"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="Admin/images/gallery/<?php echo $photo; ?>"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0 text-uppercase"
                  ...
                  style="z-index: 6; white-space: nowrap;">Aapnu<span class="text-orange">Ghar</span>
                </div>
