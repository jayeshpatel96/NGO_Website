                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Change Password <small>Enter New Passowrd</small></h2>
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form action="index.php" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                    ...
                                                    <button class="btn btn-success" name="changepassword" value="changepassword" id="changepassword">Change Password</button>
                                                </div>
                                            </div>
